    ...
    return (
        <div className={`my-10 mx-auto max-w-max md:max-w-screen-sm
            ...
            <div className="flex gap-2">
                ...
                <Link href="/privacy" className='bg-gray-900 px-5 py-2 text-white rounded-lg'>Privacy Policy</Link>
                <Link href="/privacy" className='bg-gray-900 px-5 py-2 text-white rounded-lg'>California Residents</Link>
            </div>   
        </div>
    )
}
