...
import arrivals1 from '@/public/bootscropped.webp'
...
export const Lookbook = () => {
    return (
        ...
        <div className="relative inset-0 flex flex-row gap-0.5 place-items-center">
            <Image src={arrivals1} alt="A man's legs, clad in jeans and brown boots, lying in a green forest in front of a waterfall." className="md:w-[34%] md:h-auto"/>
